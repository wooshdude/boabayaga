...
# Editor Variables
var editor_sprite: Sprite2D = Sprite2D.new()


# Called when the node enters the scene tree for the first time.
func _ready():
	if Engine.is_editor_hint():
		var editor_sprite_texture = preload("res://Assets/Sprites/snake_body_editor_icon.png")
		editor_sprite.texture = editor_sprite_texture
